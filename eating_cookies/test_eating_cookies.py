...
class Test(unittest.TestCase):
    ...
    def test_eating_cookies_small_n(self):
        self.assertEqual(eating_cookies(0, [0]), 1)
        self.assertEqual(eating_cookies(1, [0] * 2), 1)
        self.assertEqual(eating_cookies(2, [0] * 3), 2)
        self.assertEqual(eating_cookies(5, [0] * 6), 13)
        self.assertEqual(eating_cookies(10, [0] * 11), 274)
